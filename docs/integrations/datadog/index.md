...
For more information how to add card components to Roadie take a look at [the documentation on how to update dashboards.](../../getting-started/updating-the-ui/#updating-dashboards).
