...
You must be an admin in Roadie. By default, all users are admins. Learn how to designate certain users as admins [here](../../getting-started/create-admin-group/).
...
1. Visit the secrets page in Roadie. [Here's how](../../details/setting-secrets/).
...
3. Click the pencil icon to open a dialog where you can set a token. Click SAVE. Please visit the [dedicated PagerDuty plugin docs](../../integrations/pagerduty/) to learn where to get this token from.
